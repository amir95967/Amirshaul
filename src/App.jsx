...
const SafeIcon = ({ name, size = 24, className = "" }) => {
  const iconsMap = { Layout, Github, ShieldCheck, ArrowUpRight, Code2, Mail };
...
const MY_PROJECTS = [
  ...
  },
  {
    ...
    title: "System Form",
    desc: "מערכת יצירת קשר מאובטחת עם הגנת hCaptcha.",
          ...
          >
            ...
            <div className="flex justify-center items-center space-x-8">
               <a href="https://github.com/amirshaul" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-white transition-colors flex items-center space-x-2 no-underline">
                 ...
                 <span className="text-xs font-black tracking-widest uppercase">Github</span>
               </a>
               
               <div className="w-px h-4 bg-white/10 self-center" />
               
               {/* כפתור יצירת קשר עם אנימציית הבהוב איטית */}
               <motion.a 
               ...
               <div className="flex items-center space-x-2">
                 <SafeIcon name="ShieldCheck" size={20} className="text-cyan-500" />
